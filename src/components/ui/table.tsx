...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      " p-4 text-left align-middle text-[12px]  font-medium text-zinc-500 dark:text-zinc-400 sm:text-[14px] [&:has([role=checkbox])]:pr-0 ",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-4 align-middle text-[10px] sm:text-[12px]  md:text-[14px] [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
