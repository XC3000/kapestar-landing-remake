...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("bg-white p-3 dark:bg-zinc-900", className)}
      classNames={{
        ...
        day_selected:
          " text-zinc-900 hover:text-zinc-50 focus:bg-zinc-900 focus:text-zinc-50 dark:bg-zinc-50 dark:text-zinc-400 dark:hover:bg-zinc-50 dark:hover:text-zinc-900 dark:focus:bg-zinc-50 dark:focus:text-zinc-900",
        day_today:
